...
public class EgovSampleController {
	...
	public String updateSampleView(@RequestParam("id") String id, Model model) throws Exception {
	...
	public String updateSample(@Valid @ModelAttribute("sampleVO") SampleVO sampleVO, BindingResult bindingResult, Model model, SessionStatus status) throws Exception {
	...
	public String deleteSample(@ModelAttribute("sampleVO") SampleVO sampleVO, Model model, SessionStatus status) throws Exception {
